...
@media(max-width:760px),(hover:none) and (pointer:coarse){.auth-wave-back,.auth-wave-mid,.auth-wave-front{animation:none!important;transform:none!important;will-change:auto!important}}
